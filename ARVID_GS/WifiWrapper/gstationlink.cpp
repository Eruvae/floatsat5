#include "gstationlink.h"
#include <QNetworkInterface>
#include <QDateTime>
#include <QtEndian>

//GStationlink::GStationlink(QObject *parent, bool checkChecksum) : QObject(parent), localAddress("192.168.0.100"), remoteAddress("192.168.0.101"), port(2000), socket(this), bound(false), checkChecksum(checkChecksum), receivedBytes(0), sentBytes(0), timer(this){

GStationlink::GStationlink(QObject *parent) : QObject(parent), localAddress("192.168.0.109"), remoteAddress("192.168.0.120"), port(5000), socket(this), bound(false){
...
void GStationlink::addTopic(PayloadType topicId){
    topics.insert(topicId);
}

int GStationlink::write(quint32 topicId, const QByteArray &data){
...
int GStationlink::write(quint32 topicId, const Telecommand &telecommand)
{
...
//qint64 GStationlink::readAndResetReceivedBytes(){
//    unsigned ret = receivedBytes;
//    receivedBytes = 0;
//    return ret;
//}

//qint64 GStationlink::readAndResetSentBytes(){
//    unsigned ret = sentBytes;
//    sentBytes = 0;
//    return ret;
//}

bool GStationlink::isBound(){
    return bound;
}
