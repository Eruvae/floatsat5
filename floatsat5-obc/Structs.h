...
{
	STANDBY = 0, START_SEARCHING, SEARCHING_TARGET, MOVING_TO_TARGET, RENDEZVOUZ_TARGET, DOCKING
};

enum class PoseControllerMode
{
	STANDBY = 0, GOTO_POSE, FOLLOW_TRAJECTORY, CHANGE_ATTITUDE, ROTATE, FOLLOW_TRAJECTORY_T
};
